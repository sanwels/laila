(function() {
    ...
    function ma(a, b) {
        ...
        var c = a.g.h;
        if (c)
            return na(a, "return"in c ? c["return"] : function(d) {
                return {
                    value: d,
                    done: !0
                }
    ...
    function oa(a) {
        this.next = function(b) {
            z(a.g);
            a.g.h ? b = na(a, a.g.h.next, b, a.g.s) : (a.g.s(b),
            b = C(a));
            return b
        }
        ;
        this.throw = function(b) {
            z(a.g);
            a.g.h ? b = na(a, a.g.h["throw"], b, a.g.s) : (B(a.g, b),
            b = C(a));
            return b
        }
        ;
    ...
    u("Promise", function(a) {
        ...
        b.prototype.J = function(g) {
            ...
            typeof f == "function" ? this.N(f, g) : this.m(g)
        }
        ;
    ...
    u("WeakMap", function(a) {
        ...
        b.prototype.get = function(h) {
            return d(h) && D(h, g) ? h[g][this.g] : void 0
        }
        ;
        b.prototype.has = function(h) {
            return d(h) && D(h, g) && D(h[g], this.g)
        }
        ;
        b.prototype.delete = function(h) {
            return d(h) && D(h, g) && D(h[g], this.g) ? delete h[g][this.g] : !1
        }
        ;
        return b
    });
    u("Map", function(a) {
        ...
        function d(f, h) {
            var l = h && typeof h;
            l == "object" || l == "function" ? k.has(h) ? l = k.get(h) : (l = "" + ++g,
            k.set(h, l)) : l = "p_" + h;
            var m = f[0][l];
            if (m && D(f[0], l))
...
*/
    ...
    : function(a, b, c) {
        for (var d = a.length, e = typeof a === "string" ? a.split("") : a, k = 0; k < d; k++)
            k in e && b.call(c, e[k], k, a)
    }
    ;
    function za(a, b) {
        b = ya(a, b);
    ...
    function Ta() {
        for (var a = Oa(), b = RegExp("([A-Z][\\w ]+)/([^\\s]+)\\s*(?:\\((.*?)\\))?", "g"), c = [], d; d = b.exec(a); )
...
*/
    ...
    function bb(a, b) {
        ...
        if (b instanceof N)
            ...
            b = Za.test(b) ? b : void 0;
        b !== void 0 && (a.src = b)
    }
    ;function cb(a) {
        Na.test(a) && (a.indexOf("&") != -1 && (a = a.replace(Ha, "&amp;")),
    ...
    function fb() {
        ...
        typeof a === "undefined" && typeof window !== "undefined" && window.postMessage && window.addEventListener && !M("Presto") && (a = function() {
            ...
            var g = "callImmediate" + Math.random()
              , f = k.location.protocol == "file:" ? "*" : k.location.protocol + "//" + k.location.host;
            e = G(function(h) {
                if ((f == "*" || h.origin == f) && h.data == g)
    ...
    function nb() {
        if (E.Promise && E.Promise.resolve) {
            ...
            S = function() {
                var b = ob;
                typeof E.setImmediate !== "function" || E.Window && E.Window.prototype && E.Window.prototype.setImmediate == E.setImmediate ? (eb || (eb = fb()),
                eb(b)) : E.setImmediate(b)
            }
    }
    function ob() {
    ...
    p.H = function(a, b) {
        var c = this.h[a];
        if (c) {
            for (var d = Array(arguments.length - 1), e = 1, k = arguments.length; e < k; e++)
                d[e - 1] = arguments[e];
            if (this.u)
                for (e = 0; e < c.length; e++) {
                    var g = c[e];
                    qb(this.g[g + 1], this.g[g + 2], d)
                }
            else {
                this.m++;
                try {
                    for (e = 0,
                    k = c.length; e < k && !this.i; e++)
                        g = c[e],
            ...
            case 2:
                ...
                return ka(c, Promise.all(b.map(function(d) {
                    ...
                    return qa(function(k) {
                        if (k.g == 1)
                            return k.l = 2,
                            ka(k, navigator.permissions.query({
                                name: "top-level-storage-access",
                                requestedOrigin: d
                            }), 4);
                        k.g != 2 ? (e = k.m,
                        e.state === "prompt" && a.g.push(d),
                        k.g = 0,
                        k.l = 0) : (k.l = 0,
                        k.i = null,
                        k.g = 0)
    ...
    ;var W = {}
      ...
      , Bb = {};
    function Cb() {
        for (var a = v(Ab), b = a.next(); !b.done; b = a.next())
            b = b.value,
            b()
    }
    function Db(a, b) {
            ...
            a: if (Hb.has(d.origin)) {
                ...
                if (k && d.origin === k.O)
                    ...
                    case "apiInfoDelivery":
                        if (F(e))
                            for (var g in e)
                                e.hasOwnProperty(g) && (d.v[g] = e[g]);
                        break;
                    case "infoDelivery":
                        Jb(d, e);
                        break;
                    case "initialDelivery":
                        F(e) && (clearInterval(d.i),
                        d.playerInfo = {},
                        d.v = {},
                        Kb(d, e.apiInterface),
                        Jb(d, e));
    ...
    function Z(a, b) {
        ...
        if (a = typeof a === "string" ? c.getElementById(a) : a)
            if (Nb.yt_embedsEnableRsaforFromIframeApi && zb(),
            c = a.tagName.toLowerCase() === "iframe",
            b.host || (b.host = c ? sb(a.src) : "https://www.youtube.com"),
            this.h = new Fb(b),
            c || (b = Ob(this, a),
            this.l = a,
            ...
            a = b),
            this.g = a,
            this.g.id || (this.g.id = "widget" + sa(this.g)),
            W[this.g.id] = this,
            window.postMessage) {
                this.j = new U;
                Pb(this);
    ...
    function Ob(a, b) {
        ...
        (b = X(a.h, "width")) && c.setAttribute("width", b.toString());
        ...
        g.widgetid = a.id;
        window.location.href && I(["debugjs", "debugcss"], function(f) {
        ...
        a = "" + X(a.h, "host") + ("/embed/" + X(a.h, "videoId")) + "?" + ub(g);
        Nb.yt_embedsEnableIframeSrcWithIntent ? (bb(c, Ya(a)),
        ...
        if (this.g.contentWindow)
            for (var c = 0; c < b.length; c++)
                try {
                    ...
                    if (d.name && d.name === "SyntaxError")
                        d.message && d.message.indexOf("target origin ''") > 0 || console && console.warn && console.warn(d);
                    else
                        throw d;
                }
        else
    ...
    function Jb(a, b) {
        if (F(b)) {
            ...
            a.g.setAttribute("title", "YouTube " + X(a.h, "title"))))
        }
    }
    function Kb(a, b) {
        I(b, function(c) {
    ...
    Ab.push(function(a) {
        ...
        if (c.querySelectorAll && c.querySelector)
            ...
            if (b.querySelectorAll && b.querySelector)
                ...
                for (c = d = 0; b = e[c]; c++) {
                    var g = b.className, f;
                    if (f = typeof g.split == "function")
                        f = ya(g.split(/\s+/), "yt-player") >= 0;
                    f && (k[d++] = b)
                }
                k.length = d;
                b = k
